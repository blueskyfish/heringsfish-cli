...
module.exports = {
   ...
   * When call the function with more than 2 parameter, then it us the util.format function to insert into the message.
   *
   ...
   * function with more than 2 parameter, then it us the util.format function to insert into the message.
   *
   * @param {object} beans
